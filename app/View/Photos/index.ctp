<div class="photos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('rabbit_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($photo['Photo']['rabbit_id']); ?>&nbsp;</td>
		<td><?php echo h($photo['Photo']['geo_long']); ?>&nbsp;</td>
		<td><?php echo h($photo['Photo']['geo_lat']); ?>&nbsp;</td>
